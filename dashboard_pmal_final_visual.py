# ==========================================
# DASHBOARD PMAL - CONTROLE DE COMBUSTÍVEL
# Versão Corrigida (Litros padrão float, reais com 2 decimais)
# ==========================================
...
def carregar_dados():
    pasta = "C:/Users/Sec/Desktop/dashboard_pmal"
    ignorar = ["PROPRIOS_JUSTIÇA.xlsx", "LOCADOS.xlsx", "PADRÕES_LOCADOS.xlsx", "APP.PY"]
    arquivos = [f for f in os.listdir(pasta) if f.upper().endswith("ABR.XLSX") and f.upper() not in ignorar and not f.startswith("~$")]
...
def main():
    ...
    st.caption("Análise completa dos abastecimentos da frota")
    ...
    # ALERTA DE VIATURAS EM MAIS DE UMA OM, FORMATADO
